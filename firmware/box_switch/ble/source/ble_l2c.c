                     ...
                     ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    switch(msg_id)
    {
        ...
        case L2CC_LECB_CONNECT_REQ_IND:
        {
            ...
            l2c_env.connectionCount++;
            PRINTF("\r\n L2CC_LECB_CONNECT_REQ_IND: connectionCount=%d le_psm=%d peer_cid=%d",
                   l2c_env.connectionCount, ind->le_psm, ind->peer_cid);
        }
        break;
        ...
        case L2CC_LECB_CONNECT_IND:
        {
            ...
            PRINTF("\r\n L2CC_LECB_CONNECT_IND: connectionCount=%d le_psm=%d local_cid=%d peer_cid=%d",
                   l2c_env.connectionCount, ind->le_psm, ind->local_cid, ind->peer_cid);
        }
        break;
