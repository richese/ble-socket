...
/* ----------------------------------------------------------------------------
 * Function      : GATT_Env_t* GATT_GetEnv(void)
 * ----------------------------------------------------------------------------
...
/* ----------------------------------------------------------------------------
 * Function      : uint16_t GATTM_GetServiceAddedCount(void)
 * ----------------------------------------------------------------------------
 * Description   : Returns the number of GATT services that have been added.
 * Inputs        : None
 * Outputs       : The number of GATT services that have been added.
 * Assumptions   : None
 * ------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------
 * Function      : void GATTM_AddAttributeDatabase(const struct att_db_desc *att_db,
 *                                                 uint16_t att_db_len)
 * ----------------------------------------------------------------------------
 * Description   : Add multiple services/characteristics into the Bluetooth
 *                 stack database.
...
/* ----------------------------------------------------------------------------
 * Function      : uint16_t GATTM_GetHandle(uint16_t attidx)
 * ----------------------------------------------------------------------------
 ...
 *                                          uint8_t uuid_len, uint16_t start_hdl,
 *                                          uint16_t end_hdl)
 * ----------------------------------------------------------------------------
...
/* ----------------------------------------------------------------------------
 * Function      : void GATTC_SendEvtCfm(uint8_t conidx, uint16_t handle)
 * ----------------------------------------------------------------------------
 * Description   : Send a GATTC indication confirmation
 * Inputs        : conidx      - Connection index
 *                 handle      - Characteristic handle
 * Outputs       : None
 * Assumptions   : None
...
/* ----------------------------------------------------------------------------
 * Function      : void CUSTOMSS_AttInfoReqInd( ke_msg_id_t const msg_id,
 *                                  struct gattc_read_req_ind const *param,
 *                                  ke_task_id_t const dest_id,
 *                                  ke_task_id_t const src_id)
 * ----------------------------------------------------------------------------
